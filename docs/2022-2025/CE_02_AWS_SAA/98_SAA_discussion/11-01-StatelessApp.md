...
### `Problem-1`:  need static/fixed Ip 
  ...
  - ![img_1.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img_1.png)
---
...
### `problem-3` : even more traffic, scaling but no downtime
  ...
  - ![img.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img.png)
---
### `problem-4` : Soo many elastic IP.
  - r53 > add a-record (with ttl) with `dns` name with service::ec2::ec2-i1/2/3
  - ![img_2.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img_2.png)
---
### `problem-5` : ec2-i health issue and went down.
  ...
  - ![img_3.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img_3.png)
---
### `problem-6` : traffic is less, scaling down
  ...
  - ![img_4.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img_4.png)
  - ![img_6.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img_6.png)
---
### `problem-7` : Availability issue / DR
  - deploy` app/ec2-i` in multiple AZ / az-1, az-2, az-3
  - deploy `ALB` in multiple AZ  / az-1, az-2, az-3 
  - ![img_5.png](../../../99_img/2025/aws-ssa/ssa-discussion/11-1/img_5.png)
