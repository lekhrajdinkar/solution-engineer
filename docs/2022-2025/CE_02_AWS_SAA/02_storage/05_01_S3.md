...
## 1. S3: Intro
- by default, the AWS **S3 bucket owner** has `full access` to the bucket and all objects within it 👈
...
- expose s3 object as public access endpoint
  ...
  - V**PC-endpoint** --> s3:access-point --> bucket:selected-object
    - ![img_1.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_100.png)
...
- ![img.png](../../../99_img/2025/aws-ssa/storage/snow/img-98.png)

- ![img.png](../../../99_img/2025/aws-ssa/storage/s3-3/img-99.png)   
...
- **retrieval policy** in aws s3 glacier class for regular and randon retrieval, to save cost ?
  ...
  - free tier : 10% free retrival per month 👈
...
- can set up an **expiration action** (to delete) + **transitional actions** 👈
- **tiers**
...
#### comparison
- ![img_4.png](../../../99_img/2025/aws-ssa/storage/s3-1/img_4.png)
- ![img.png](../../../99_img/2025/aws-ssa/storage/s3-2/img.png)
- ![img_1.png](../../../99_img/2025/aws-ssa/storage/s3-2/img_1.png)
...
### comparison
![img_1.png](../../../99_img/2025/aws-ssa/refactor/01/img_1.png)
...
- **server side**
  ...
  - ![img_3.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_3.png)
  - ![img_2.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_2.png)
  - ![img_1.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_1.png)

- **client side encryption**
  - outside AWS
  - object enc/decr at client end.

- ![img_4.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_4.png)
...
- ![img.png](../../../99_img/2025/aws-ssa/storage/s3-3/img.png)
...
- eg:
  ...
  - ![img_1.png](../../../99_img/2025/aws-ssa/storage/s3-1/img_1.png)
...
- ![img_2.png](../../../99_img/2025/aws-ssa/storage/s3-1/img_2.png)
- ![img_3.png](../../../99_img/2025/aws-ssa/storage/s3-1/img_3.png)
...
- speed up content transfers **to and from** Amazon S3 by as much as 50-500% 
  - for **long-distance transfer of larger objects** 👈 :dart:
...
- ![img_3.png](../../../99_img/2025/aws-ssa/storage/s3-2/img_3.png)

### 9.2 byte-range fetch (DOWN)
- parallelize GETS to speed up download. can configure how many `bytes` to read.
- ![img_4.png](../../../99_img/2025/aws-ssa/storage/s3-2/img_4.png)
...
- ![img_5.png](../../../99_img/2025/aws-ssa/storage/s3-2/img_5.png)

### 9.4 requester pay
- network cost on requester
- ![img_2.png](../../../99_img/2025/aws-ssa/storage/s3-2/img_2.png)
...
![img_6.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_6.png)

![img_7.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_7.png)

![img_5.png](../../../99_img/2025/aws-ssa/storage/s3-3/img_5.png)
