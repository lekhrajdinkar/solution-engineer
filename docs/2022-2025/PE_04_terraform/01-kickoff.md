...
![img.png](../../99_img/2025/terraform/04_trf_img/01/img-04.png)

## install / setup
- windows: install binary in local, set PATH.

![img_1.png](../../99_img/2025/terraform/04_trf_img/01/img_1.png)
...
- under projects > add **workspace** (cli/api driven)
    ...
    - ![img.png](../../99_img/2025/terraform/04_trf_img/01/img-ws-type.png)
